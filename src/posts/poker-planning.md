...
isEng: false
title: "Алгоритм Покер-планирования"
---
...
- [[#Что за оценки|Что за оценки]]
	- [[#Что за оценки#Зачем это нужно|Зачем это нужно]]
	- [[#Что за оценки#Противоречие относительных оценок|Противоречие относительных оценок]]
	- [[#Что за оценки#Какая оценка что значит|Какая оценка что значит]]
## Что такое
